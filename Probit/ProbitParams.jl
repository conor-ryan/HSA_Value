...
#
# function parDict(x::Vector{T},spec::Vector{Symbol},opt_num::Int,N::Int,draw_num::Int) where T
#     # Parameter Vectors
#     β = x[1:length(spec)]
#     Σ = Matrix{T}(undef,opt_num,opt_num)
#     k = length(spec)+1
#     for i in 1:opt_num
#         for j in i:opt_num
#             Σ[j,i] = 0.0
...
#     A = sqrt(Σ)
#     Z = MVHaltonNormal(draw_num,opt_num)
#     ϵ = permutedims(Z*A,(2,1))
#
#
#     # Initialize individual shares
#     s_ij = Vector{T}(undef,N*opt_num)
#
